...
2. Representar gráficamente mediante el paquete ```CairoMakie.jl```.
...
\hspace{-0.4em}\text{v₂}(t) = -A\,ω₁ \sin(ω₁ t + δ)
\end{gather}$
"
...
# ╔═╡ 079fe3dd-18e2-4a3e-bf6f-9799d210ac69
...
\begin{gather}
\text{Eje x:}\hspace{1em} \boldsymbol{F}ₑ₂ = m₂\,\mathbf{a₂}\hspace{1em}\longrightarrow\hspace{1em}-kx = m₂ \,\text{a₂} \\
\hspace{0.8em}\text{Eje y:}\hspace{1em} \boldsymbol{N}ₛ₂ + m₂\,\boldsymbol{g} =0\hspace{1em}\longrightarrow\hspace{1em}Nₛ₂ = m₂\, g
\end{gather}$
"
...
begin
	fv = Figure()
	axfv = Axis(fv[1, 1],
				title = "VELOCIDADES DE m₁, m₂ y CM (TOTAL)",
				xlabel = "Tiempo (s)", ylabel = "Velocidad (m/s)"
	)
	
	lines!(axfv, ODE_fase1_t, ODE_fase1_v₁,
		   linewidth = 4,
		   color = :blue, alpha = 0.35,
...
begin
	fa = Figure()
	axfa = Axis(fa[1, 1],
				title = "ACELERACIONES DE m₁, m₂ y CM (TOTAL)",
				xlabel = "Tiempo (s)", ylabel = "Aceleración (m/s²)"
	)
	
	lines!(axfa, ODE_fase1_t, ODE_fase1_a₁,
		   linewidth = 4,
		   color = :blue, alpha = 0.35,
...
begin
	fE = Figure()
	axfE = Axis(fE[1, 1],
				title = "ENERGÍA CINÉTICA, POTENCIAL Y MECÁNICA (TOTAL)",
				xlabel = "Tiempo (s)", ylabel = "Energía (J)"
	)
	
	lines!(axfE, ODE_fase1_t, ODE_fase1_Ec,
		   linewidth = 4,
		   color = :blue, alpha = 0.35,
		   label = "Ec(t) ODE fase 1"
	)
	lines!(axfE, ODE_fase2_t, ODE_fase2_Ec,
		   linewidth = 5.0,
		   color = :blue, alpha = 1.0,
		   label = "Ec(t) ODE fase 2"
	)
	lines!(axfE, ODE_fase1_t, ODE_fase1_Ep,
		   linewidth = 4,
		   color = :red, alpha = 0.35,
...
manifest_format = "2.0"
project_hash = "112e48417763e7ed92ea5bbd9152b16c071248ed"
